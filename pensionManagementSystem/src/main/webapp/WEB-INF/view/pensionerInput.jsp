...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	pageEncoding="ISO-8859-1" isELIgnored="false"  errorPage=""%>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
<body
	style="background-image: url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR9dxDrkWcsylyvJOpsHggQS5eR5fUNtEYtq3wAdh-0eR7OAFzt3wGAkFoVxz7gL2Pramk&usqp=CAU); background-size:100%;background-repeat: no-repeat; background-position: inherit;">
	<header>
		<nav class="navbar bg-light transparent">
			...
			<a href="/portal/logout" style="align: right;"class="btn btn-primary">Logout</a>
		</nav>
	</header>
	<section>
		<div class="container">
					...
					<form:form name="form" action="getPensionerDetail" method="post"
						...
						<div class="form-group">
							<input name="pan" path="pan" type="text" class="form-control"
								placeholder="PAN Number" required="required" pattern="[A-Z]{5}[0-9]{4}[A-Z]{1}" 
								 title="Example : ABCDE1234F"/>
						</div>
						<div class="form-group">
							<input placeholder="Aadhar" name="aadharNumber"
								path="aadharNumber" type="text" class="form-control"
								required="required" pattern="[0-9]{12}" title="Must contain 12 digits only"/> 
								<small style="color:black" class="form-text ">Your
