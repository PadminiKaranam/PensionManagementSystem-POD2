...
<body
	style="background-image: url(https://previews.123rf.com/images/belchonock/belchonock1807/belchonock180706220/105034667-cubes-with-word-retirement-coins-and-compass-on-grey-background-pension-concept.jpg); background-size: cover; background-repeat: no-repeat; background-position: center;">
	<header>
	...
	<section>
		<div class="container">
			...
			<div class="float-center"
				style="margin-top: 80px; background-color: #94b8b8; height:300px;  width: 400px; box-shadow: 5px 10px 8px 10px #888888; padding: 30px; border-radius: 5mm;">
