...
<li class="nav-item text dark font-bold ml-auto"><a href="/portal/logout" class="btn btn-primary"  >Logout</a></li>
</ul></nav>
	</header>
	<section>
	<div class="container" style="margin-top: 200px;">
		...
		<br>
		<h3 class="text-success font-weight-bold" style="color: #336600" id="errorMessage">${info}</h3>
	</div>
	</section>
